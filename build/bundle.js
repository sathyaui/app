...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createElement(Router, { history: history }, React.createElement(Route, null, React.createElement(Redirect, { from: '/', to: '/getstarted' }), React.createElement(Route, { path: 'getstarted', component: Getstarted }), React.createElement(Route, { path: 'stream', component: Stream })));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Getstarted = React.createClass({
			...
			render: function render() {
					return React.createElement('div', { className: 'getstarted' }, React.createElement('div', { id: 'signUp', className: 'text-center' }, React.createElement('div', { id: 'getStart', className: 'formMessageArea' }, React.createElement('h2', null, 'Hi, Let’s Set you up'), React.createElement('p', null, 'Follow the following screens', React.createElement('br', null), ' to quickly set you up.'), React.createElement('input', { type: 'submit', value: 'Get started', className: 'button button-white' })), React.createElement('div', { id: 'setTwitter', className: 'setTwitter' }, React.createElement('a', { href: '#', className: 'backArrow' }, React.createElement('i', { className: 'fa fa-chevron-left' })), React.createElement('h2', null, 'Set up Twitter Digits'), React.createElement('div', { className: 'formGroup' }, React.createElement('div', { className: 'group' }, React.createElement('input', { className: 'inputMaterial', type: 'text', required: true }), React.createElement('span', { className: 'highlight' }), React.createElement('span', { className: 'bar' }), React.createElement('label', null, 'Name')), React.createElement('div', { className: 'group' }, React.createElement('input', { className: 'inputMaterial', type: 'text', required: true }), React.createElement('span', { className: 'highlight' }), React.createElement('span', { className: 'bar' }), React.createElement('label', null, 'Mobile'))), React.createElement('input', { type: 'submit', className: 'button button-white', value: 'Send code' })), React.createElement('div', { id: 'verifyNumber', className: 'verifyNumber' }, React.createElement('a', { href: '#', className: 'backArrow' }, React.createElement('i', { className: 'fa fa-chevron-left' })), React.createElement('h2', null, 'Verify your mobile number'), React.createElement('div', { className: 'formGroup' }, React.createElement('div', { className: 'group' }, React.createElement('input', { className: 'inputMaterial', type: 'password', maxLength: '6', required: true }), React.createElement('span', { className: 'highlight' }), React.createElement('span', { className: 'bar' }), React.createElement('label', null, 'Enter 6 digit code'))), React.createElement('input', { type: 'submit', className: 'button button-white', value: 'Create account' })), React.createElement('div', { id: 'confirmation', className: 'formMessageArea' }, React.createElement('h2', null, 'Thank you for completing the set up'), React.createElement('p', null, 'Your now just a button away from borrowing your stuff'), React.createElement('a', { href: '#', className: 'button button-white' }, 'Discover'))), React.createElement(Link, { to: '/stream' }, 'Breakfast'));
			}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Stream = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement('div', null, React.createElement('h1', null, 'Test'), React.createElement(Link, { to: '/getstarted' }, 'Home'), this.props.children);
	  }
	});
